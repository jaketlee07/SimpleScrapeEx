...
public class MainActivity extends AppCompatActivity {
    ...
    static Button buttonMoreTopics;
    static int choice = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMoreTopics = (Button)findViewById(R.id.moreTopics);
    }
    ...
    public void moreTopicsPage(View v)
    {
        Intent intent = new Intent(MainActivity.this, MoreNewsTopics.class);
